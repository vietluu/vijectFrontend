...
export const register = createAsyncThunk<{ token: string }, type.userRegister, ThunkAPI>(
  "user/thunk/register",
...
export const updateProfile = createAsyncThunk<type.user, { image?: string; fullName?: string }, ThunkAPI>(
  "user/thunk/updateProfile",
  async (req, { rejectWithValue }) => {
    try {
